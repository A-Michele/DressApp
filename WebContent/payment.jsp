			...
			<div class="card-body">
				<form method="post">
					<div class="form-group">
						<label>Proprietario</label> <input id="prop" type="text"
							class="form-control" name="payment-proprietario"
							placeholder="Nome Cognome proprietario" required>
					</div>
					<div class="form-group">
						<label>Numero carta</label> <input id="numCarta" type="text"
							class="form-control" name="payment-num" placeholder="n."
							required>
					</div>
					
					<div class="form-group">
						<label>Data di scadenza</label> <input id="dataScadenza" type="text"
					...
					<div class="text-center">
						<button id="addCard" type="button" class="btn btn-primary" style="background: #404040;border:#404040;">Aggiungi</button>
					</div>
				</form>
			</div>
		</div><% } %>
