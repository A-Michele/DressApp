...
import java.net.URL;
public class TCModificaQuantitProdottoNelCarrelloTest {
  ...
  @Test
  public void tCQuantitDisponibile() {
  ...
  @Test
  public void tCQuantitInDisponibile() {
    driver.get("http://localhost:8080/dressapp/cart.jsp");
    driver.manage().window().setSize(new Dimension(974, 1032));
    assertThat(driver.getTitle(), is("DressApp - Carrello"));
    driver.findElement(By.cssSelector(".fa-plus-square")).click();
    driver.findElement(By.cssSelector(".fa-plus-square")).click();
    assertThat(driver.findElement(By.cssSelector("p")).getText(), is("*Quantità non disponibile"));
  }
}
